...
class AntdDragModal extends React.PureComponent {
  ...
  onContentMoseDown(e: any) {
    this.dragging = false;
    document.onmousemove = null;
  }

  render() {
    const { zIndex = 999, children, wrapClassName, title, width = 520, ...otherProps } = this.props;
    return (
      <Modal
        zIndex={zIndex}
        width={width}
        ...
        centered={true}
      >
        <div onMouseDown={this.onContentMoseDown}>{children}</div>
      </Modal>
    );
  }
}
